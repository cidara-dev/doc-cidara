...
###### Versi terakhir Botstrap adalah v5.2, yang bisa di lihat [disini](https://getbootstrap.com/docs/5.2/getting-started/introduction/)

# Ini adalah Tutorial Dasar belajar Bootstrap,Jika Anda merasa EXPERT,Skip aja Bagian ini