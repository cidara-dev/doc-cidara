...
Di halaman ikhtisar situs Anda di Netlify, Anda akan melihat nama proyek yang dibuat secara acak, dan URL situs web Anda dalam bentuk https://doc-cidara.netlify.app. Anda dapat mengubah nama proyek Anda menjadi sesuatu yang lebih mudah diingat, dan ini akan secara otomatis memperbarui URL Anda.
